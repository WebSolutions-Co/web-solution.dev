...
export const TracingBeam = ({
	...
	useEffect(() => {
		if (contentRef.current) {
			setSvgHeight(contentRef.current.offsetHeight - 27);
		}
	}, []);
	useEffect(() => {
	...
	return (
		<motion.div
			className={cn(
				'relative w-full max-w-content mx-auto h-full',
				className
			)}
		>
			<div className='absolute hidden ml-4 xl:ml-0 lg:block left-0 top-3'>
				...
				>
					...
					<defs>
						...
						>
							<stop stopColor='#00DF83' stopOpacity='0'></stop>
							<stop stopColor='#00DF83'></stop>
							<stop offset='0.325' stopColor='#00BF63'></stop>
							<stop
								offset='1'
								stopColor='#00BF63'
								stopOpacity='0'
